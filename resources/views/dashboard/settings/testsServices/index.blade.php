...
@section('admin_title', 'خدمات التحاليل')
@section('css')
    <!-- DataTables -->
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/plugins/datatables-bs4/css/dataTables.bootstrap4.css">
@endsection
@section('active-testsServices', 'active')
@section('page-header', 'جدول خدمات التحاليل')
@section('page-header_desc', 'جدول خدمات التحاليل')
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">جدول خدمات التحاليل</h3>
                </div>
                <div class="card-header">
