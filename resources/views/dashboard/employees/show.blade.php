        ...
        <div class="col-md-12">
            ...
            <div class="card card-secondary">
                <div class="card-header">
                    <a href="{{ route('dashboard.employees.edit', $data['id']) }}"
                            ...
                            <div class="tab-pane fade show active" id="custom-content-below-home" role="tabpanel"
                                ...
                                <div class="row my-4"> {{-- Start First Row of From --}}
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select disabled name="blood_types_id" id="blood_types_id"
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select disabled name="social_status" id="social_status"
                                            class="form-control font-w">
                            ...
                            <div class="tab-pane fade" id="custom-content-below-profile" role="tabpanel"
                                ...
                                <div class="row my-4"> {{-- Start Seconed Row of From --}}
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select disabled name="job_grade_id" id="job_grade_id"
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select disabled name="has_fixed_shift" id="has_fixed_shift"
                                            class="form-control font-w">
                            ...
                            <div class="tab-pane fade" id="custom-content-below-messages" role="tabpanel"
                                ...
                                <div class="row my-4"> {{-- Start Seconed Row of From --}}
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select disabled name="driving_license" id="driving_license"
                                            class="form-control font-w">
                                            <option value="" disabled selected>-- برجاء التحديد --
                                            </option>
