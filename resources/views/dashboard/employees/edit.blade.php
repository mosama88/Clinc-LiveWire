...
@section('admin_title', 'تعديل موظف')
@section('css')
    <!-- Select2 -->
...
@section('page-header', ' تعديل موظف')
@section('page-header_desc', 'تعديل موظف')
                                ...
                                <div class="row my-4"> {{-- Start First Row of From --}}
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input disabled type="text" class="form-control font-w" name="employee_code"
                                            value="{{ old('employee_code', $data['employee_code']) }}" id="exampleInputName"
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="date" class="form-control font-w" name="brith_date"
                                            value="{{ old('brith_date', $data['brith_date']) }}" id="brith_date"
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select name="religion" id="religion" class="form-control font-w">
                                            ...
                                            <option @if (old('religion', $data['religion']) == 'christian') selected @endif value="christian">
                                                مسيحى
                                            </option>
                                        </select>
                                        @error('religion')
                                ...
                                <div class="row my-4"> {{-- Start Seconed Row of From --}}
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control font-w" name="major"
                                            value="{{ old('major', $data['major']) }}" id="major"
                                ...
                                <div class="row my-4"> {{-- Start Seconed Row of From --}}
                                    ...
                                    <div class="form-group col-6 d-none" id="military_wepon_Div">
                                        ...
                                        <input type="text" class="form-control font-w" name="military_wepon"
                                            ...
                                            id="military_wepon" placeholder="أدخل التخصص ">
                                    ...
                                    <div class="form-group col-6 d-none" id="military_postponement_date_Div">
                                        ...
                                        <input type="date" class="form-control font-w"
                                            ...
                                            value="{{ old('military_postponement_date', $data['military_postponement_date']) }}"
                                ...
                                <div class="row my-4"> {{-- Start Seconed Row of From --}}
                                        ...
                                        <select name="shift_type_id" id="shift_type_id" class="form-control font-w">
                                            ...
                                            @if (!empty($other['shift_types']) && isset($other['shift_types']))
                                                @foreach ($other['shift_types'] as $shift)
                                                    ...
                                                    <option @if (old('shift_type_id', $data['shift_type_id'], $shift['shift_type_id'] == $shift->id)) selected @endif
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select name="fixed_allowances" id="fixed_allowances"
                                            ...
                                            <option @if (old('fixed_allowances', $data['fixed_allowances']) == '1') selected @endif value="1">
                                                نعم
                                            </option>
                                            <option @if (old('fixed_allowances', $data['fixed_allowances']) == '0') selected @endif value="0">
                                                لا
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select name="medical_insurance" id="medical_insurance"
                                            ...
                                            <option @if (old('medical_insurance', $data['medical_insurance']) == '1') selected @endif value="1">
                                                نعم
                                            </option>
                                            <option @if (old('medical_insurance', $data['medical_insurance']) == '0') selected @endif value="0">
                                                لا
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select name="Type_salary_receipt" id="Type_salary_receipt"
                                            ...
                                            <option @if (old('Type_salary_receipt', $data['Type_salary_receipt']) == '1') selected @endif value="1">
                                                كاش
                                            </option>
                                            <option @if (old('Type_salary_receipt', $data['Type_salary_receipt']) == '2') selected @endif value="2">
                                                فيزا
                                            </option>
                                        </select>
                                ...
                                <div class="row my-4"> {{-- Start Seconed Row of From --}}
                                    ...
                                    <div class="form-group col-6 d-none" id="relatives_details_Div">
                                        ...
                                        <input type="text" class="form-control font-w" name="relatives_details"
                                            value="{{ old('relatives_details', $data['relatives_details']) }}"
                                            id="relatives_details" placeholder="أدخل تفاصيل الاقارب بالعمل">
                                    ...
                                    <div class="form-group col-6">
                                        <label for="exampleInputName">تفاصيل شخص يمكن الرجوع اليه للوصول للموظف
                                        </label>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea class="form-control font-w" rows="3" name="notes" placeholder="أدخل ملاحظات">{{ old('notes', $data['notes']) }}</textarea>
                                        @error('notes')
                                            <div class="alert alert-danger" role="alert">
                                                {{ $message }}
                                            </div>
