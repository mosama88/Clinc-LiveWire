...
<head>
    ...
    <!-- Ion Slider -->
    <link rel="stylesheet" href="{{asset('dashboard')}}/assets/plugins/ion-rangeslider/css/ion.rangeSlider.min.css">
    <!-- bootstrap slider -->
    <link rel="stylesheet" href="{{asset('dashboard')}}/assets/plugins/bootstrap-slider/css/bootstrap-slider.min.css">
    <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
                                    ...
                                    <div class="row margin">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="range_2" type="text" name="range_2" value="1000;100000"
                                                data-type="double" data-step="500" data-postfix=" &euro;"
                                                data-from="30000" data-to="90000" data-hasgrid="true">
                                        </div>
                                    </div>
                                    <div class="row margin">
                                        <div class="col-sm-6">
    ...
    <!-- Bootstrap slider -->
    <script src="{{asset('dashboard')}}/assets/plugins/bootstrap-slider/bootstrap-slider.min.js"></script>
    <script>
        $(function() {
            /* BOOTSTRAP SLIDER */
