...
<!-- PAGE {{asset('dashboard')}}/assets/PLUGINS -->
<!-- jQuery Mapael -->
...
<script src="{{asset('dashboard')}}/assets/plugins/jquery-mapael/maps/world_countries.min.js"></script>
<!-- ChartJS -->
