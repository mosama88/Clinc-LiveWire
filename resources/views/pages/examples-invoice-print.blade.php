@section('active-examples-invoice-print','active')
        ...
        <section class="invoice">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <img src="{{asset('dashboard')}}/assets/dist/img/credit/mastercard.png" alt="Mastercard">
                    <img src="{{asset('dashboard')}}/assets/dist/img/credit/american-express.png" alt="American Express">
