                                    ...
                                    <ul class="nav nav-pills flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="#"><i
                                                    class="far fa-circle text-danger"></i> Important</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#"><i
                                                    class="far fa-circle text-warning"></i> Promotions</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#"><i
                                                    class="far fa-circle text-primary"></i> Social</a>
                                        </li>
                                    </ul>
                                </div>
                                <!-- /.card-body -->
                                    ...
                                    <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                                        ...
                                        <li>
                                            <span class="mailbox-attachment-icon has-img"><img
                                                    src="{{asset('dashboard')}}/assets/dist/img/photo1.png"
                                                    alt="Attachment"></span>
                                        ...
                                        <li>
                                            <span class="mailbox-attachment-icon has-img"><img
                                                    src="{{asset('dashboard')}}/assets/dist/img/photo2.png"
                                                    alt="Attachment"></span>
