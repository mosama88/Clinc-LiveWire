@section('active-calendar','active')
...
<head>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="{{asset('dashboard')}}/assets/plugins/fullcalendar/main.min.css">
  <link rel="stylesheet" href="{{asset('dashboard')}}/assets/plugins/fullcalendar-interaction/main.min.css">
  <link rel="stylesheet" href="{{asset('dashboard')}}/assets/plugins/fullcalendar-daygrid/main.min.css">
  <link rel="stylesheet" href="{{asset('dashboard')}}/assets/plugins/fullcalendar-timegrid/main.min.css">
  <link rel="stylesheet" href="{{asset('dashboard')}}/assets/plugins/fullcalendar-bootstrap/main.min.css">
  <!-- Theme style -->
...
<script src="{{asset('dashboard')}}/assets/plugins/fullcalendar/main.min.js"></script>
<script src="{{asset('dashboard')}}/assets/plugins/fullcalendar-daygrid/main.min.js"></script>
<script src="{{asset('dashboard')}}/assets/plugins/fullcalendar-timegrid/main.min.js"></script>
<script src="{{asset('dashboard')}}/assets/plugins/fullcalendar-interaction/main.min.js"></script>
<script src="{{asset('dashboard')}}/assets/plugins/fullcalendar-bootstrap/main.min.js"></script>
