...
<head>
    ...
    <!-- jsGrid -->
    <link rel="stylesheet" href="{{asset('dashboard')}}/assets/plugins/jsgrid/jsgrid.min.css">
    <link rel="stylesheet" href="{{asset('dashboard')}}/assets/plugins/jsgrid/jsgrid-theme.min.css">
    <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
    ...
    <!-- jsGrid -->
    <script src="{{asset('dashboard')}}/assets/plugins/jsgrid/demos/db.js"></script>
    <script src="{{asset('dashboard')}}/assets/plugins/jsgrid/jsgrid.min.js"></script>
    <!-- AdminLTE App -->
