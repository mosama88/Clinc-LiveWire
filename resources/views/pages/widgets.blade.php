                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-widget widget-user">
                                ...
                                <div class="widget-user-image">
                                    <img class="img-circle elevation-2"
                                        src="{{asset('dashboard')}}/assets/dist/img/user1-128x128.jpg" alt="User Avatar">
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-widget widget-user">
                                ...
                                <div class="widget-user-image">
                                    <img class="img-circle" src="{{asset('dashboard')}}/assets/dist/img/user3-128x128.jpg"
                                        alt="User Avatar">
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="card card-widget">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <img class="img-fluid pad" src="{{asset('dashboard')}}/assets/dist/img/photo2.png"
                                        alt="Photo">
                                ...
                                <div class="card-footer">
                                    <form action="#" method="post">
                                        <img class="img-fluid img-circle img-sm"
                                            src="{{asset('dashboard')}}/assets/dist/img/user4-128x128.jpg" alt="Alt Text">
                            ...
                            <div class="card card-widget">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="attachment-block clearfix">
                                        <img class="attachment-img" src="{{asset('dashboard')}}/assets/dist/img/photo1.png"
                                            alt="Attachment Image">

                                        <div class="attachment-pushed">
                                            <h4 class="attachment-heading"><a href="http://www.lipsum.com/">Lorem
